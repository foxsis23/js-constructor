...
var _animeJpeg = require("./assets/anime.jpeg");
var _animeJpegDefault = parcelHelpers.interopDefault(_animeJpeg);
...
const model = [
    new _blocks.TitleBlock('My JS app project', {
        tag: 'h2',
        styles: {
    ...
    new _blocks.ImageBlock(_animeJpegDefault.default, {
        styles: {
            display: 'flex',
    ...
    new _blocks.TextBlock(`It's my first project on JS with Parcel :)`, {
        styles: {
            color: 'red',
    ...
    new _blocks.ColumnsBlock(colValue, {
        styles: {
            color: 'blue',
            'background-color': '#E5F0FF',
            'font-family': `'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif`
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./assets/anime.jpeg":"En7vt","./classes/blocks":"gMfMj"}],"gkKU3":[function(require,module,exports) {
...
},{}],"En7vt":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('bLxZJ') + "anime.9007c61a.jpeg" + "?" + Date.now();
...
class ImageBlock extends Block {
    ...
    toHTML() {
        ...
        return _utils.row(`<img src="${this.value}" alt="${alt}" style="${_utils.css(imageStyles)}"/>`, _utils.css(styles));
    }
}
class ColumnsBlock extends Block {
    ...
    toHTML() {
        let html = this.value.map((item)=>_utils.col(item)
        );
        return _utils.row(html.join(''), _utils.css(this.options.styles));
    }
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"g9LQJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Sidebar {
    ...
    add(event) {
        ...
        let newBlock;
        if (type === 'title') newBlock = new _blocks.TitleBlock(value, {
            styles: styles
        });
        else if (type === 'text') newBlock = new _blocks.TextBlock(value, {
            styles: styles
        });
        else if (type === 'image') newBlock = new _blocks.ImageBlock(value, {
            styles: styles
        });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../utils":"en4he","./blocks":"gMfMj"}],"clPKd":[function() {},{}]},["7nZVA","8lqZg"], "8lqZg", "parcelRequirebbb8")
